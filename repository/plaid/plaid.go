...
func (s *Service) SetAccessToken(c context.Context, id int, accountID string, e *request.SetAccessToken) (interface{}, error) {
	...
	// fraud detection
	/*
	plaid has their own - verification within 30 seconds
	- verification of each document
	- she will have to talk to an identify verification specialist
	
	Plaid timeline:
	- can move as quickly as needed
	support@plaid.com

	Next Meeting:
	- user projects based on funding tiers
	follow up with KYC for financial advisory with Alpaca
	*/
