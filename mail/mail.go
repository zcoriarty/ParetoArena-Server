...
func NewMail(mc *config.MailConfig, sc *config.SiteConfig) *Mail {
	return &Mail{
		...
		FromName:    "Pareto App",
		FromEmail:   "paretoapp@paretoapp.co",
	}
}
